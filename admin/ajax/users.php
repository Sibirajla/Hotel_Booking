...
if (isset($_POST['get_users'])) {
  ...
  while ($row = mysqli_fetch_assoc($res)) {
    ...
    if($row['is_verified']){
      $verified ="<span class='badge bg-info text-dark'><i class='bi bi-patch-check-fill'></i></span>";
      $del_btn ="";
    }
    else{
      $verified ="<span class='badge bg-warning text-dark'><i class='bi bi-patch-exclamation-fill'></i></span>";
    }
