...
<div class="container-fluid" id="main-content">
  <div class="row">
    <div class="col-lg-10 ms-auto p-4 overflow-hidden">
      <h3 class="mb-4"><i class="bi bi-star-half fs-3 me-2 ms-1"></i> RATINGS & REVIEWS</h3>
              ...
              <tbody>
                <?php 
                 ...
                 while($row = mysqli_fetch_assoc($data))
                 {
                  ...
                  $seen.= "<a href='?del=$row[sr_no]'class='btn btn-sm rounded-pill btn-danger ms-3'>Delete";
