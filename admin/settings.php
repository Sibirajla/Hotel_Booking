      ...
      <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
          ...
          <h6 class="card-subtitle mb-1 fw-bold">Site tittle</h6>
           <p class="card-text" id="site_tittle"></p>
          <h6 class="card-subtitle mb-1 fw-bold">About us</h6>
           <p class="card-text" id="site_about"></p>
        </div>
      </div>

      <!-- General settings section Modal -->
          ...
          <form id="general_s_form">
            <div class="modal-content">
              ...
              <div class= "mb-3">
                ...
                <input type="text" name="site_tittle" id="site_tittle_inp" class="form-control shadow-none" required>
              </div>
              <div class= "mb-3">
              ...
              <div class="modal-footer">
                ...
                <button type="button" onclick ="site_tittle.value = general_data.site_tittle,site_about.value = general_data.site_about" class="btn text-secondary shadow-none" data-bs-dismiss="modal">CANCEL</button>
                    ...
                    <div class="col-md-6">
                      <div class= "mb-3">
                        ...
                        <div class="input-group mb-3">
                          ...
                          <input type="text" name="insta" id="insta_inp" class="form-control shadow-none" r>
                        </div>
                        <div class="input-group mb-3">
