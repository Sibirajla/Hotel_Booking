    ...
    <div class="col-lg-10 ms-auto p-4 overflow-hidden">
      ...
      <div class="d-flex align-items-center justify-content-between mb-4">
        ...
        <?php 
          ...
          {
            echo<<<data
              <h6 class="badge bg-danger py-2 px-3 rounded"><i class="bi bi-exclamation-triangle"></i> Shutdown Mode is Active</h6>
            data;
          }
        ?>
      </div>
      ...
      <div class="row mb-4">
        ...
        <div class="col-md-3 mb-4">
          <a href="refund_bookings.php" class="text-decoration-none text-warning">
            <div class="card text-center p-3">
        ...
        <div class="col-md-3 mb-4">
          <a href="user_queries.php" class="text-decoration-none text-info">
            <div class="card text-center p-3">
              <h6>User Queries</h6>
        ...
        <div class="col-md-3 mb-4">
          <a href="rate_review.php" class="text-decoration-none text-info">
            <div class="card text-center p-3">
