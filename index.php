      ...
      <form action="rooms.php">
        <div class="row align-items-end">
          ...
          <div class="col-lg-2  mb-3">
            <label class="form-label" style="font-weight: 500;" required>Children</label>
...
<div class="container">
  <div class="row">
    <div class="col-lg-8 col-md-8 p-4 mb-lg-0 mb-3 bg-white rounded">
      <!-- Map -->
    <iframe class="w-100 rounded" height="320px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3908.6719699865453!2d77.58666227594827!3d11.575357043947765!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ba947a0ecd5b12d%3A0x974d733b4fdd25c5!2sAnthiyur%20Bus%20Stand!5e0!3m2!1sen!2sin!4v1684139813390!5m2!1sen!2sin"  loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
    </div>
    <div class="col-lg-4 col-md-4">
      <!-- Phone Number-->
      <div class="bg-white p-4 rounded mb-4">
        <h5>Call us</h5>
        <a href="tel: +918778464694" class="d-inline-block mb-2 tecxt-decoration-none text-dark">
         <i class="bi bi-telephone-fill"></i> +918778464694
        </a>
        <br>
        <a href="tel: +918778464694" class="d-inline-block mb-2 tecxt-decoration-none text-dark">
         <i class="bi bi-telephone-fill"></i> +918778464694
...
<script>
  ...
  var swiper = new Swiper(".swiper-testimonials", {
    ...
    xhr.onload = function() 
    {
     ...
     {
      alert('success','Account Reset Successfu!');
      recovery_form.reset();
