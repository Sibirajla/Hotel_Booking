...
{
    $user_q = select("SELECT * FROM `user_cred` WHERE `id`=? LIMIT 1", array($uid), 'i');
...
$isValidChecksum = verifychecksum_e($paramList, PAYTM_MERCHANT_KEY, $paytmChecksum); // Returns TRUE or FALSE string.
